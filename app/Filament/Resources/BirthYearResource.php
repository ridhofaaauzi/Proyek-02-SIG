...
class BirthYearResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListBirthYears::route('/'),
            'create' => Pages\CreateBirthYear::route('/create'),
            'edit' => Pages\EditBirthYear::route('/{record}/edit'),
        ];
    }
}
